...
```
git clone git@github.com:alonsojasl/personal-web-source.git personal-web-source
cd cemrgapp-web-src
git submodule update --init --recursive
# git submodule add -f -b main git@github.com:alonsoJASL/alonsojasl.github.io.git public
```
